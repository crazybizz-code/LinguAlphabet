...
//
// createCommitmentStage() is exported alongside the `commitmentStage`
// singleton (same factory+singleton pattern as onboarding/store.js)
// so each instance's DOM/selection state lives in its own closure.
...
export function createCommitmentStage() {
...
export const commitmentStage = createCommitmentStage();

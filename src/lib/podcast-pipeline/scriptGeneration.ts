...
===================== LENGTH: READ THIS FIRST -- IT OUTRANKS EVERY OTHER SECTION =====================
...
THE 935-950 TARGET OUTRANKS EVERY OPTIONAL ELEMENT IN THIS PROMPT. The items marked MANDATORY or NON-NEGOTIABLE throughout this prompt (the hook, both self-introductions, the LinguABC mention, the interruption pair, a natural sign-off, prosody density, and the requested CEFR level) must all still appear -- but CONVERSATIONAL FEATURES below is a menu of OPTIONAL texture, not a checklist to complete in full. If including everything in that section would push you past 950 words, include fewer of them -- do not add more words elsewhere to compensate. Equally, do not cut so much optional texture that you drop under 930: both edges of 920-965 are hard requirements, not just the ceiling -- keep just enough optional content to genuinely land inside 935-950, not the bare minimum needed to clear 920.
...
===================== CONVERSATIONAL FEATURES (OPTIONAL TEXTURE -- SEE LENGTH ABOVE) =====================
These are OPTIONAL texture, not a checklist -- per the LENGTH section above, the 935-950 word target outranks including all of them. Naturally work in TWO OR THREE of the following, whichever actually fit the topic, never all of them: a short reaction, a follow-up question, a self-correction or unfinished thought ("...", trailing off), a mild disagreement or pushback, a moment of humor, a small personal example or story from at least one speaker, or a brief callback near the end to something mentioned earlier. Short reactions and follow-up questions are cheap (a few words) and safe to include freely; a personal example/story and a callback cost the most words, so if you are already near 950 words, drop one of those two first. Do not force filler words into every sentence.
